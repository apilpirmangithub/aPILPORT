    ...
    <div className="min-h-screen selection:bg-brand-primary selection:text-surface-50 bg-surface-50 pb-20">
      ...
      <section id="about" className="relative pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-[12vw] lg:text-[12vw] font-display font-bold text-ink-900 leading-[0.75] tracking-tighter mb-10">
              Apil<span className="text-brand-primary">.</span>
            </h1>
            <p className="text-xl md:text-3xl text-ink-700 max-w-5xl mx-auto font-light leading-relaxed mb-12">
              AI Creator & AI Developer blending creative idealism with professional execution.
            </p>
            <div className="grid grid-cols-3 max-w-sm md:max-w-xl mx-auto mt-20">
              <a href="#experience" className="group flex flex-col items-center gap-4">
                ...
                <span className="inline-block font-bold tracking-[0.3em] uppercase text-[10px] md:text-xs text-ink-400 group-hover:text-ink-900 transition-colors -mr-[0.3em]">Trajectory</span>
              </a>
      ...
      {/* Experience Section */}
      <section id="experience" className="py-20 px-6 border-y border-surface-200">
        <div className="max-w-7xl mx-auto">
          <SectionHeader title="Trajectory" subtitle="History" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {EXPERIENCES.map((exp: any, index) => (
              <motion.div 
                ...
                className="group p-6 border border-transparent hover:border-surface-200 rounded-2xl transition-all"
              >
                <div className="text-sm font-bold text-brand-primary tracking-[0.3em] uppercase mb-4">{exp.period}</div>
                <div className="flex items-start justify-between gap-4 mb-2">
                  <h3 className="text-2xl font-display font-bold text-ink-900 group-hover:italic transition-all">{exp.title}</h3>
                  {exp.url && (
                    <a 
                      href={exp.url} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-surface-100 text-ink-400 hover:bg-brand-primary hover:text-ink-900 transition-all"
                    >
                      <ExternalLink size={14} />
                    </a>
                  )}
                </div>
                <div className="h-[1px] w-full bg-surface-200 mb-4 group-hover:w-1/2 transition-all" />
                <p className="text-ink-700 leading-relaxed font-light text-base">
                  {exp.description}
                </p>
              </motion.div>
            ))}
